  ...
  return (
    <>
      <div style={{ position: 'sticky', top: 0, zIndex: 50 }}>
        ...
        {/* Main header */}
        <header style={{ background: 'linear-gradient(to bottom, rgba(0,10,50,0.35) 0%, rgba(0,10,50,0) 100%), #0041BD' }}>
          {isMobile ? (
            ...
            <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', gap: '16px', height: `${headerHeight}px` }}>
              <Link href="/" style={{ display: 'flex', alignItems: 'center', flexShrink: 0 }}>
                <img src="https://i.imgur.com/ymv6DC9.png" alt="WAGGLE TAIL" style={{ height: `${logoHeight}px`, width: 'auto' }} />
              </Link>
        ...
        {/* 모바일 카테고리 빠른 탐색 — 메인 제외, CSS로 데스크탑 숨김 */}
        <nav className="wt-catnav" style={{ background: '#111', overflowX: 'auto', msOverflowStyle: 'none', scrollbarWidth: 'none', display: pathname === '/' ? 'none' : undefined } as React.CSSProperties}>
        ...
        <>
          ...
          <div style={{ position: 'fixed', top: 0, left: 0, bottom: 0, width: '80vw', maxWidth: '320px', background: '#fff', zIndex: 201, display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', borderBottom: '1px solid #f0f0f0' }}>
              <img src="https://i.imgur.com/ymv6DC9.png" alt="WAGGLE TAIL" style={{ height: '24px', width: 'auto' }} />
