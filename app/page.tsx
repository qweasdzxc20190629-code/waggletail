    ...
    <div style={{ fontFamily: 'system-ui, -apple-system, sans-serif', color: '#111' }}>
      ...
      <div style={{ background: '#111', color: '#fff', fontSize: '13px' }}>
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px', display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: '18px', height: '38px' }}>
          ...
          <a href="#" style={{ opacity: 0.82, fontWeight: 500, color: 'inherit', textDecoration: 'none' }}>로그인</a>
          <a href="#" style={{ opacity: 0.82, fontWeight: 500, color: 'inherit', textDecoration: 'none' }}>회원가입</a>
      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 50, background: '#fff', borderBottom: '2px solid #111' }}>
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', gap: '28px', height: '84px' }}>
          <a href="#" style={{ display: 'flex', alignItems: 'center' }}>
            <img src="https://i.imgur.com/oUTo3OQ.png" alt="WAGGLE TAIL" style={{ height: '68px', width: 'auto' }} />
          </a>
          <div style={{ flex: 1, display: 'flex', alignItems: 'center', border: '2.5px solid #111', borderRadius: '999px', padding: '11px 8px 11px 20px', maxWidth: '520px' }}>
            <input 
              type="text" 
              placeholder="사료, 간식, 장난감, 산책용품 검색" 
              style={{ flex: 1, border: 'none', outline: 'none', fontSize: '15px', background: 'transparent' }} 
            />
            <button style={{ background: '#0041BD', width: '38px', height: '38px', borderRadius: '50%', border: 'none', display: 'grid', placeItems: 'center', cursor: 'pointer' }}>
        ...
        <nav style={{ borderTop: '1px solid rgba(17,17,17,.14)' }}>
          <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px', display: 'flex', gap: '6px', height: '52px', alignItems: 'center', overflowX: 'auto' }}>
      ...
      <section style={{ background: '#0041BD', color: '#fff', position: 'relative', overflow: 'hidden' }}>
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: '1.05fr .95fr', gap: '40px', alignItems: 'center', paddingTop: '64px', paddingBottom: '64px', minHeight: '480px' }}>
          <div>
            <p style={{ fontSize: '13px', fontWeight: '800', letterSpacing: '0.14em', marginBottom: '18px', color: '#FFDC20' }}>FOR A HAPPIER WALK</p>
            <h1 style={{ fontSize: '48px', fontWeight: '900', marginBottom: '20px', lineHeight: '1.1', letterSpacing: '-0.03em' }}>
              우리 강아지의 하루를<br />
        ...
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px' }}>
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '34px', gap: '20px', flexWrap: 'wrap' }}>
            <div>
              ...
              <h2 style={{ fontSize: '40px', fontWeight: 900, letterSpacing: '-0.03em', lineHeight: '1.05' }}>무엇이 필요하세요?</h2>
            </div>
        ...
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px' }}>
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '24px', gap: '20px', flexWrap: 'wrap' }}>
            <div>
              ...
              <h2 style={{ fontSize: '40px', fontWeight: 900, letterSpacing: '-0.03em', lineHeight: '1.05' }}>이번 주 신상품</h2>
            </div>
      ...
      <section style={{ background: '#FFDC20' }}>
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: '1.1fr .9fr', gap: '40px', alignItems: 'center', paddingTop: '72px', paddingBottom: '72px' }}>
          <div>
            <p style={{ fontSize: '13px', fontWeight: 800, letterSpacing: '0.14em', marginBottom: '14px', color: '#0041BD' }}>AUTO DELIVERY</p>
            <h2 style={{ fontSize: '48px', fontWeight: 900, letterSpacing: '-0.03em', lineHeight: '1.04', marginBottom: '18px' }}>매달 쓰는 건,<br />알아서 도착하게.</h2>
        ...
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px' }}>
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '34px', gap: '20px', flexWrap: 'wrap' }}>
            <div>
              ...
              <h2 style={{ fontSize: '40px', fontWeight: 900, letterSpacing: '-0.03em', lineHeight: '1.05' }}>꾸준히 사랑받는 베스트</h2>
            </div>
      ...
      {/* BRAND STORY */}
      <section style={{ background: '#0041BD', color: '#fff', position: 'relative', overflow: 'hidden' }}>
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '96px 24px', textAlign: 'center', position: 'relative', zIndex: 2 }}>
          ...
          <h2 style={{ fontSize: '52px', fontWeight: 900, letterSpacing: '-0.03em', lineHeight: '1.1', maxWidth: '760px', margin: '0 auto 22px' }}>
        ...
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px' }}>
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: '34px', gap: '20px', flexWrap: 'wrap' }}>
            <div>
              ...
              <h2 style={{ fontSize: '40px', fontWeight: 900, letterSpacing: '-0.03em', lineHeight: '1.05' }}>보호자들의 진짜 후기</h2>
            </div>
      ...
      <footer style={{ background: '#111', color: '#fff', padding: '64px 0 40px' }}>
        <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 24px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr 1fr 1fr', gap: '32px', paddingBottom: '44px', borderBottom: '1px solid rgba(255,255,255,.15)' }}>
            <div>
