          ...
          <div style={{ marginBottom: '24px' }}>
            <div style={{ marginBottom: '56px' }}>
              ...
              <div style={{ fontSize: '15px', color: '#555', lineHeight: 1.8, maxWidth: '640px', fontFamily: "'Pretendard', sans-serif", display: 'flex', flexDirection: 'column', gap: '14px' }}>
                <p style={{ margin: 0, fontFamily: "'Pretendard', sans-serif", fontWeight: 500 }}>산책을 기다리는 설레는 순간부터 신나게 뛰어노는 시간,<br className="mob-br" />맛있는 간식을 즐기는 휴식 시간까지.<br className="mob-br" />와글테일은 반려견의 일상 곳곳에 행복이 더해질 수 있도록<br className="mob-br" />꼭 필요한 제품만 엄선하여 소개합니다.</p>
