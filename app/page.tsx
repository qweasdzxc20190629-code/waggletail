...
export default async function Home() {
  ...
  return (
    <div style={{ fontFamily: "'Pretendard', sans-serif", color: '#222' }}>
      {/* HERO */}
      <section style={{ background: 'linear-gradient(to bottom, rgba(0,0,0,0.38) 0%, rgba(0,0,0,0) 380px), url("https://i.imgur.com/1hGLx3I.png"), #0041BD', backgroundSize: '100% auto', backgroundPosition: 'top center', color: '#fff', position: 'relative', overflow: 'hidden' }}>
        <div className="wt-container wt-hero-grid" style={{ position: 'relative', zIndex: 2, maxWidth: '1240px', margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: '1.05fr .95fr', gap: '40px', alignItems: 'center', paddingTop: '64px', paddingBottom: '450px', minHeight: '480px' }}>
          ...
          <div style={{ display: 'none', gridTemplateColumns: '1fr 1fr', gap: '16px', alignItems: 'stretch' }}>
          ...
          <div style={{ marginBottom: '24px' }}>
            <div style={{ marginBottom: '56px' }}>
              ...
              <div style={{ fontSize: '15px', color: '#555', lineHeight: 1.8, maxWidth: '640px', fontFamily: "'Pretendard', sans-serif", display: 'flex', flexDirection: 'column', gap: '14px' }}>
                <p style={{ margin: 0, color: '#111' }}>산책을 기다리는 설레는 순간부터 신나게 뛰어노는 시간,<br className="mob-br" />맛있는 간식을 즐기는 휴식 시간까지.<br className="mob-br" />와글테일은 반려견의 일상 곳곳에 행복이 더해질 수 있도록<br className="mob-br" />꼭 필요한 제품만 엄선하여 소개합니다.</p>
