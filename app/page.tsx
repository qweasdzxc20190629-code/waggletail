...
export default async function Home() {
  ...
  return (
    <div style={{ fontFamily: "'Pretendard', sans-serif", color: '#222' }}>
      {/* HERO */}
      <section style={{ background: 'linear-gradient(to bottom, rgba(0,0,0,0.38) 0%, rgba(0,0,0,0) 380px), url("https://i.imgur.com/1hGLx3I.png"), #0041BD', backgroundSize: 'cover', backgroundPosition: 'top center', color: '#fff', position: 'relative', overflow: 'hidden' }}>
